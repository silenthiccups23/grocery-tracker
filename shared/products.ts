...
export const PRODUCT_CATALOG: ProductEntry[] = [
  ...
  { name: "Bagels", aliases: ["bagel", "bagles", "bagells", "raisin bagels", "raisin bagel", "everything bagel", "cinnamon bagel"],
    category: "Bakery", defaultUnit: "ct",
    relevantTags: ["Bagel", "Whole Wheat", "Gluten-Free", "Organic", "Plain", "Raisin", "Everything", "Cinnamon"] },
  { name: "Donuts", aliases: ["donut", "doughnut", "doughnuts", "donas", "glazed donut"],
    category: "Bakery", defaultUnit: "ct",
    relevantTags: ["Glazed", "Chocolate", "Powdered", "Organic"] },
  { name: "Muffins", aliases: ["muffin", "blueberry muffin", "banana muffin"],
    category: "Bakery", defaultUnit: "ct",
    relevantTags: ["Blueberry", "Banana", "Chocolate", "Organic", "Gluten-Free"] },
  { name: "Cake", aliases: ["birthday cake", "chocolate cake", "pastel"],
    category: "Bakery", defaultUnit: "oz",
    relevantTags: ["Chocolate", "Vanilla", "Organic"] },
  ...
  { name: "Pizza Rolls", aliases: ["pizza roles", "pizza roll", "totinos", "totino's"],
    category: "Frozen", defaultUnit: "ct",
    relevantTags: ["Pizza", "Single Serve", "Family Size"] },
  { name: "Frozen Burritos", aliases: ["burrito", "frozen burrito"],
    category: "Frozen", defaultUnit: "ct",
    relevantTags: ["Burrito", "Conventional", "Organic", "Single Serve"] },
  { name: "Frozen Dinner", aliases: ["tv dinner", "frozen meal", "lean cuisine", "hungry man", "stouffers"],
    category: "Frozen", defaultUnit: "oz",
    relevantTags: ["Dinner", "Conventional", "Organic", "Low-Calorie", "Single Serve"] },
  { name: "Frozen Pancakes", aliases: ["frozen pancake"],
    category: "Frozen", defaultUnit: "ct",
    relevantTags: ["Pancakes", "Conventional", "Organic", "Gluten-Free"] },
  { name: "Chicken Nuggets", aliases: ["chicken nugget", "nuggets", "dino nuggets", "chicken tenders"],
    category: "Frozen", defaultUnit: "oz",
    relevantTags: ["Chicken", "Conventional", "Organic", "Breaded"] },
  { name: "French Fries", aliases: ["fries", "frozen fries", "tater tots", "papas fritas"],
    category: "Frozen", defaultUnit: "oz",
    relevantTags: ["Conventional", "Organic", "Family Size"] },
  ...
  { name: "Soda", aliases: ["coke", "pepsi", "cola", "sprite", "refresco", "coca cola", "coca-cola", "dr pepper", "mountain dew", "fanta", "7up", "root beer"],
    category: "Beverages", defaultUnit: "fl oz",
  ...
  { name: "Cereal", aliases: ["cheerios", "frosted flakes", "corn flakes", "cocoa puffs", "lucky charms", "fruit loops", "froot loops", "raisin bran", "cinnamon toast crunch", "life cereal", "special k", "honey bunches"],
    category: "Pantry", defaultUnit: "oz",
  ...
  { name: "Alfredo Sauce", aliases: ["alfredo", "alfredo pasta sauce"],
    category: "Pantry", defaultUnit: "oz",
    relevantTags: ["Sauce", "Regular", "Organic"] },
  { name: "Pasta Sauce", aliases: ["marinara", "spaghetti sauce", "tomato sauce", "ragu", "prego"],
    category: "Pantry", defaultUnit: "oz",
    relevantTags: ["Sauce", "Regular", "Organic", "Low-Sodium", "No Sugar Added"] },
  { name: "Ketchup", aliases: ["catsup"],
    category: "Pantry", defaultUnit: "oz",
    relevantTags: ["Sauce", "Regular", "Organic", "No Sugar Added"] },
  { name: "Hot Sauce", aliases: ["salsa picante", "tabasco", "sriracha", "tapatio", "cholula", "valentina"],
    category: "Pantry", defaultUnit: "fl oz",
    relevantTags: ["Sauce", "Regular", "Organic", "Spicy"] },
  { name: "Soy Sauce", aliases: ["salsa de soya", "tamari"],
    category: "Pantry", defaultUnit: "fl oz",
    relevantTags: ["Sauce", "Regular", "Low-Sodium", "Organic"] },
  { name: "BBQ Sauce", aliases: ["barbecue sauce"],
    category: "Pantry", defaultUnit: "oz",
    relevantTags: ["Sauce", "Regular", "Organic", "Spicy"] },
  { name: "Ranch Dressing", aliases: ["ranch", "salad dressing"],
    category: "Pantry", defaultUnit: "fl oz",
    relevantTags: ["Regular", "Low-Fat", "Organic"] },
